...
public class FundsTransferServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<TransactionData> data = Transactions.fundsTransfer(Integer.parseInt(request.getParameter("fromAccountID")), Integer.parseInt(request.getParameter("toAccountID")), Float.parseFloat(request.getParameter("amount")));
